...
def save_all_results(results: List[Dict], output_path: str = "gsm8k/evaluation_results-2.json"):
    ...
    output_data = {
        "metadata": {
            ...
            "model_path": "ThomasTheMaker/gm3-270m-TinyGSM-reasoning",
...
def initialize_results_file(output_path: str = "gsm8k/evaluation_results-2.json"):
...
def save_result_incrementally(result: Dict, output_path: str = "gsm8k/evaluation_results-2.json"):
...
if __name__ == "__main__":
    ...
    output_file = "gsm8k/evaluation_results-2.json"
